...
import android.widget.CustomAnalogNumClock;
...
public class KeyguardStatusView extends GridLayout implements
    ...
    private CustomAnalogNumClock mAnalogClockNumView;
    ...
    protected void onFinishInflate() {
        ...
        mAnalogClockNumView = findViewById(R.id.analog_clock_num_view);
        ...
        mVisibleInDoze = new View[]{/*mBatteryDoze, */mClockView, mAnalogClockView, mAnalogClockNumView, mDeadPoolClockView, mDotClockView, mSpectrumClockView, mSneekyClockView, mSpideyClockView, mKeyguardStatusArea};
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        // Custom analog clock with numbers
        MarginLayoutParams customnumlayoutParams = (MarginLayoutParams) mAnalogClockNumView.getLayoutParams();
        customnumlayoutParams.bottomMargin = getResources().getDimensionPixelSize(
                R.dimen.bottom_text_spacing_digital);
        mAnalogClockNumView.setLayoutParams(customnumlayoutParams);
    ...
    public void refreshTime() {
	    ...
	    mClockView.setFormat12Hour(Html.fromHtml("<strong>h:mm</strong>"));
            ...
            mClockView.setFormat12Hour(Html.fromHtml("h<br><font color=" + getResources().getColor(R.color.sammy_minutes_accent) + ">mm</font>"));
	...
	if (mClockSelection == 2) {
        ...
        switch (mClockSelection) {
            ...
            case 4: // analog with number
                ...
                paramsWeather.addRule(RelativeLayout.BELOW, R.id.analog_clock_num_view);
                mAnalogClockView.registerReceiver();
    ...
    public void setDark(float darkAmount) {
        ...
        mAnalogClockNumView.setDark(dark);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
           ...
           resolver.registerContentObserver(Settings.System.getUriFor(
                  Settings.System.HIDE_LOCKSCREEN_ALARM), false, this, UserHandle.USER_ALL);
           resolver.registerContentObserver(Settings.System.getUriFor(
